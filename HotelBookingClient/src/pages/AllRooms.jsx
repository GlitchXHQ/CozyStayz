...
const AllRooms = () => {
    ...
    // Handler for room type checkboxes
    ...
    // Handler for price range checkboxes
    ...
    // Handler for sort radio buttons
    ...
    lg:px-24 xl-px-32'>
        ...
        <div>
            <div>
                ...
                <p className='text-sm md:text-base text-gray-500/90 mt-2'>Memories aren't just the moments we witness — they are the ones we feel with emotion, togetherness, and love.</p>
                <p className='text-sm md:text-base text-gray-500/90'>Book your stay now and create memories worth keeping.</p>
            </div>
        ...
        <div className='bg-white w-80 border border-gray-300 text-gray-600 max-lg:mb-8 lg:mt-16'>
                <div
                className={`flex items-center justify-between px-5 py-2.5 lg:border-b
                 border-gray-300 ${filters && 'border-b'}`}>
                    <p className='text-base font-medium text-gray-800'>FILTERS</p>
                    <div className='text-xs cursor-pointer'>
                        <span className='lg:hidden' 
                        onClick={()=>setFilters(!filters)}>
                            {filters?"HIDE":"SHOW"}</span>
                        <span className='hidden lg:block' onClick={handleClearFilters}>CLEAR</span>
                    </div>
                </div>

                <div className={`${filters? 'h-auto':'h-0 lg:h-auto'}
