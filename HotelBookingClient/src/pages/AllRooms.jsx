...
const AllRooms = () => {
  ...
  const { fetchRooms, navigate, rooms } = useAppContext();
    ...
    <div className="flex flex-col-reverse lg:flex-row items-start justify-between pt-28 md:pt-35 px-4 md:px-16 lg:px-24 xl-px-32">
      <div>
        ...
        <p className="text-sm md:text-base text-gray-500/90 mt-2">
          Memories aren't just the moments we witness — they are the ones we feel with emotion, togetherness, and love.
        </p>
        <p className="text-sm md:text-base text-gray-500/90">
          Book your stay now and create memories worth keeping.
        </p>
      ...
      <div className="bg-white w-80 border border-gray-300 text-gray-600 max-lg:mb-8 lg:mt-16">
        <div className="flex items-center justify-between px-5 py-2.5 lg:border-b border-gray-300">
          ...
          <div className="text-xs cursor-pointer">
            <span className="lg:block" onClick={handleClearFilters}>
              CLEAR
            </span>
          </div>
        </div>
