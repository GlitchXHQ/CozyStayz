...
const AddRoom = () => {
  ...
  return (
    <form action="">
      ...
      <div className='w-full flex flex-row max-sm:flex-col sm:gap-4 mt-4'>
        <div className='flex flex-col max-w-48 items-center'>
          <p className='text-gray-800 mt-6.5'>Room Type</p>
          <select
        ...
        <div>
          ...
          <input
            ...
            onChange={e => setInput({ ...input, pricePerNight: Number(e.target.value) })}
          />
        </div>
      </div>
